...
/**
 * Build the "PSM fully approved" notification email for the submitter.
 ...
 */
function buildPsmApprovedEmail({
  approval_request_id,
  request_number,
  summary,
  submitter_name,
  ...
  const subject = `FCOS: PSM ${request_number} Approved`
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
      <div style="background-color: #1a1a2e; color: #ffffff; padding: 16px 24px;">
        ...
        <div style="font-size: 18px; font-weight: bold; margin-top: 4px;">PSM Approved</div>
      </div>
      <div style="padding: 24px; border: 1px solid #e0e0e0;">
        <p>Dear ${submitter_name},</p>
        <p>Your PSM submission has been fully approved.</p>
        ...
        <p>You may now proceed with this PSM as approved.</p>
      </div>
...
module.exports = { buildPsmApprovedEmail }
