...
/**
 * Build the first-approval notification email.
 * Pure function — no Firestore access, no payload_snapshot access.
 *
 * @param {Object} params
 ...
 */
function buildPsmApprovalEmail({
  approval_request_id,
  request_number,
  summary,
  approver_name,
  ...
  const subject = `FCOS Approval Required: ${request_number}`
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
      <div style="background-color: #1a1a2e; color: #ffffff; padding: 16px 24px;">
        ...
        <div style="font-size: 18px; font-weight: bold; margin-top: 4px;">Approval Request</div>
      </div>
      <div style="padding: 24px; border: 1px solid #e0e0e0;">
        <p>Dear ${approver_name},</p>
        <p>A new PSM has been submitted and requires your approval.</p>
        <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
          ...
          <tr>
            <td style="padding: 8px 0; color: #666;">Approval Request ID</td>
            <td style="padding: 8px 0;">${approval_request_id}</td>
          </tr>
          <tr>
        ...
        <p>Please log in to FCOS to review and act on this request.</p>
      </div>
...
module.exports = { buildPsmApprovalEmail }
